...
// Example
// ---------
// For inputString = "2 apples, 12 oranges", the output should be 14.

function sumUpNumbers(inputString) {
    let numArr = inputString.match(/[0-9]+/g)
    return parseInt(numArr === null ? 0 : numArr.reduce((a,b) => parseInt(a)+parseInt(b)))
}