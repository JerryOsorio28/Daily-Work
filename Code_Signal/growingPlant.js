...
function growingPlant(upSpeed, downSpeed, desiredHeight) {
    //variable that tracks the days that has passed
    let days = 1
    //variable that keep a track of the plant height
    let plantHeight = upSpeed
    //loop to count how many days has passed
    while(plantHeight < desiredHeight){
        // we want sum the current height of plant with the upspeed minus the downSpeed
